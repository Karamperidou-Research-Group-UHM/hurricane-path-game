...
export default class WindArrows {
  ...
  constructor(windArrowData, gameArea, highPressureSystem, lowPressureSystem) {
  ...
  createWindArrows() {
    ...
    for (let i = 0; i < this.windArrowData.length; i++) {
      const windArrow = new WindArrow(this.windArrowData[i].x, this.windArrowData[i].y, 42, 30, '../images/WindArrow.png', this.gameArea, true, this.windArrowData[i].windDir, this.highPressureSystem, this.lowPressureSystem);
