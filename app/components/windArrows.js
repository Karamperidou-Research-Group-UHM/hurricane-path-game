...
export default class WindArrows {
  ...
  createWindArrows() {
    ...
    for (let i = 0; i < this.windArrowData.length; i++) {
      ...
      const windArrow = new WindArrow(this.windArrowData[i].x, this.windArrowData[i].y, 21, 15, '../images/WindArrow.png', this.gameArea, true, 0, this.highPressureSystem, this.lowPressureSystem, this.hurricane);
